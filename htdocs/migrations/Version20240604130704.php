 ...
 */
final class Version20240604130704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE roadtrip ADD user_id INT NOT NULL, ADD vehicle_id INT DEFAULT NULL, ADD rental_vehicle_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE roadtrip DROP user_id, DROP vehicle_id, DROP rental_vehicle_id');
    }
}
